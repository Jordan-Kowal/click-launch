...
4. Fixed bug where changing resource history length instantly updates. Meaning that if I have 25min and want to switch to 100min, I'll type 1, and it will directly slice all the history to the new length, leading to data loss. Maybe wait until defocus.
